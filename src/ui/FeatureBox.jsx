function FeatureBox({ icon: Icon, title, desc }) {
  return (
    <div className="flex flex-col items-start gap-4 rounded-2xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 bg-secondary-100 border border-secondary-100">
